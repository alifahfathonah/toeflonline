...
$(document).ready(function () {
  if (banyak < 1 || banyak > 50) {
    ...
    window.location.href = base_url + "angkatan";
  } else {
    generate(banyak);
  }

  $("#inputs input:first").select();
  $("form#angkatan input").on("change", function () {
    $(this).parent(".form-group").removeClass("has-error");
    $(this).next(".help-block").text("");
  });

  $("form#angkatan").on("submit", function (e) {
    e.preventDefault();
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input autocomplete="off" type="text" name="nama_angkatan[${i}]" class="input-sm form-control">
