                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-group col-sm-12">
                            <label>Operator (Mata Ujian)</label>
                            <?php if ($this->ion_auth->is_admin()) : ?>
                                <select name="operator_id" required="required" id="operator_id" class="select2 form-group" style="width:100% !important">
                                    <option value="" disabled selected>Pilih Operator</option>
                                    <?php foreach ($operator as $d) : ?>
                                        <option value="<?= $d->id_operator ?>:<?= $d->mataujian_id ?>"><?= $d->nama_operator ?> (<?= $d->nama_mataujian ?>)</option>
                                    <?php endforeach; ?>
                                </select>
