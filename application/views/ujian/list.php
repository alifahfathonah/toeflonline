<div class="row">
    <div class="col-sm-3">
        <div class="alert bg-green">
            <h4>Kelompok<i class="pull-right fa fa-building-o"></i></h4>
            <span class="d-block"> <?= $peserta->nama_kelompok ?></span>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="alert bg-blue">
            <h4>Angkatan<i class="pull-right fa fa-graduation-cap"></i></h4>
            <span class="d-block"> <?= $peserta->nama_angkatan ?></span>
        </div>
    </div>
    <div class="col-sm-3">
