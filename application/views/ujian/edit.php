        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Mata Ujian <i class="fa fa-book pull-right"></i></h4>
                    <p><?= $mataujian->nama_mataujian ?></p>
                </div>
                <div class="alert bg-purple">
                    <h4>Operator <i class="fa fa-address-book-o pull-right"></i></h4>
                    <p><?= $operator->nama_operator ?></p>
                </div>
            </div>
            <div class="col-sm-4">
                <?= form_open('ujian/save', array('id' => 'formujian'), array('method' => 'edit', 'operator_id' => $operator->id_operator, 'mataujian_id' => $mataujian->mataujian_id, 'id_ujian' => $ujian->id_ujian)) ?>
