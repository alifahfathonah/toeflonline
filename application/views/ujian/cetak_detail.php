...
$html = <<<EOD
<p>
Hasil ujian berikut merupakan list skor sementara yang sudah dikerjakan oleh peserta untuk dapat panitia olah berikutnya!
</p>
<table>
    <tr>
        <th>Nama Ujian</th>
...
foreach ($hasil as $row) {
    ...
    <tr>
        ...
        <td width="15%">{$row->nama_kelompok}</td>
        <td width="25%">{$row->nama_angkatan}</td>
