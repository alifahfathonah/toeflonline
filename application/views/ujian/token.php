<div class="callout callout-info">
    ...
    <p>
        <ul>
            <li>Mulailah dengan membaca basmalah atau dengan doa masing-masing.</li>
            <li>Waktu ujian diberikan selama waktu yang ditentukan pada label merah di bawah ini.</li>
            <li>Silahkan jawab pertanyaan dengan opsi yang disediakan A, B, C, dan D.</li>
            <li>Jika anda telah selesai menjawab semua pertanyaan, silahkan klik SELESAI.</li>
        </ul>
    </p>
</div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Operator</th>
                        <td><?= $ujian->nama_operator ?></td>
                    </tr>
                    <tr>
                        <th>Kelompok/Angkatan</th>
                        <td><?= $peserta->nama_kelompok ?> / <?= $peserta->nama_angkatan ?></td>
                    </tr>
                    <tr>
                        <th>Nama Ujian</th>
                    ...
                    <div class="box-body pb-0">
                        ...
                        <?php else : ?>
                            <div class="callout callout-danger">
                                ...
                                Silahkan hubungi operator anda untuk bisa mengikuti ujian pengganti.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
