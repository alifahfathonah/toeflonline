<?= form_open('operator/save', array('id' => 'formoperator'), array('method' => 'add')); ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input autofocus="autofocus" onfocus="this.select()" type="number" id="no_identitas" class="form-control" name="no_identitas" placeholder="No Identitas">
