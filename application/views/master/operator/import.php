<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Mata Ujian, hanya bisa diisi menggunakan ID Mata Ujian. <a data-toggle="modal" href="#mataujianId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/operator.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('operator/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="<?= $data['nama_operator'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['nama_operator'] == null ? 'BELUM DIISI' : $data['nama_operator'];; ?>
                                        </td>
                            ...
                            <?php
                                    if ($data['no_identitas'] == null || $data['nama_operator'] == null || $data['email'] == null || $data['mataujian_id'] == null) {
                                        $status = false;
                                    }
                                endforeach;
                            }
                    ...
                    <?php if ($status) : ?>
                        ...
                        <?= form_open('operator/do_import', null, ['data' => json_encode($import)]); ?>
