<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/angkatan.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('angkatan/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('angkatan/do_import', null, ['angkatan' => json_encode($import)]); ?>
