<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-4">
			...
			<a href="<?= base_url('angkatan/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
		...
		<table id="angkatan" class="w-100 table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th>No.</th>
					<th>Angkatan</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<?= form_open('angkatan/add', array('id', 'tambah')); ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/master/angkatan/data.js"></script>